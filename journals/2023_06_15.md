...
- example `minikube start --nodes 2 -p local-cluster  --disk-size='5gb' --driver=docker`  --> careful here on what thew driver facilitates irt services!! e.g. quemu or quemu2
