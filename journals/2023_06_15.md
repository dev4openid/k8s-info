...
- ### Main Kubectl Commands - K8s CLI  (00:44:52)
  ...
  1:16:16 - Demo Project: MongoDB and MongoExpress  (1:16:16)
-
-
-
-
...
- minikube start / stop / delete / status
  ...
  `minikube start --namespace=learn --disk-size='5gb' --driver=docker`
  
  
  --> careful here on what thew driver facilitates irt services!! e.g. quemu or quemu2
