...
- Tips:
	...
	- `minikube -p local-cluster addons enable metrics-server` to generate metrics for dashboard
...
- Summary:  (01:01:43)
	...
	- *==Debugging pods:==*
		...
		- `kubectl port=forward service/nginx-service 8083:8080` ---> means you now can access the service  via the  .... exec -it .... as you are in the node pod
