...
- Over alloc of POD mem leads to evaluation of all Requests, then Limits followed by QoS determination (1. BestEffort (no resources defined), 1. Burstable, 3. Guaranteed Where Request = limits are equal size)
- ==Note:==
